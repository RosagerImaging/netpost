...
async function handler(req, res) {
    ...
    try {
        ...
        const { startDate, endDate, granularity = 'day', // day, week, month
        platform, category } = req.query;
      ...
      `)
        ...
        const processedData = processSalesData(sales || [], granularity);
        ...
        let comparisonQuery = database_1.supabaseAdmin
            .from('marketplace_listings')
            .select(`
        price,
        quantity,
...
function processSalesData(sales, granularity) {
    const groupedData = {};
    sales.forEach(sale => {
